...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_1280_SDOClientParameter = {
        ...
        {
            .dataOrig = &OD_PERSIST_COMM.x1280_SDOClientParameter.node_IDOfTheSDOClient,
            .subIndex = 3,
            .attribute = ODA_SDO_RW,
            .dataLength = 1
        }
    ...
    .o_1281_SDOClientParameter = {
        {
            .dataOrig = &OD_PERSIST_COMM.x1281_SDOClientParameter.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x1281_SDOClientParameter.COB_IDClientToServerTx,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x1281_SDOClientParameter.COB_IDServerToClientRx,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x1281_SDOClientParameter.node_IDOfTheSDOClient,
            .subIndex = 3,
            .attribute = ODA_SDO_RW,
            .dataLength = 1
        }
    ...
    .o_2005_clearFeedbackBit = {
        .dataOrig = &OD_RAM.x2005_clearFeedbackBit,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
    .o_2006_clearCurrentPositionBit = {
        .dataOrig = &OD_RAM.x2006_clearCurrentPositionBit,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
    .o_2007_limitedStopMethod = {
        .dataOrig = &OD_RAM.x2007_limitedStopMethod,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 4
    },
    .o_2008_turnOnSpeed = {
        .dataOrig = &OD_PERSIST_COMM.x2008_turnOnSpeed,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 2
    },
    .o_2009_registerConfiguration = {
        .dataOrig = &OD_PERSIST_COMM.x2009_registerConfiguration,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 2
    },
    .o_200A_maxSpeed = {
        .dataOrig = &OD_RAM.x200A_maxSpeed,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 2
    },
    .o_200D_CANID = {
        .dataOrig = &OD_PERSIST_COMM.x200D_CANID,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 2
    },
    .o_200F_syncFlag = {
        .dataOrig = &OD_PERSIST_COMM.x200F_syncFlag,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2013_temperatureThreshold = {
        .dataOrig0 = &OD_RAM.x2013_temperatureThreshold_sub0,
        .dataOrig = &OD_RAM.x2013_temperatureThreshold[0],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataElementLength = 2,
    ...
    .o_2014_ratedCurrent = {
        .dataOrig = &OD_RAM.x2014_ratedCurrent,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2015_maxCurrent = {
        .dataOrig = &OD_PERSIST_COMM.x2015_maxCurrent,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 4
    },
    .o_2026_temperature = {
        .dataOrig0 = &OD_PERSIST_COMM.x2026_temperature_sub0,
        .dataOrig = &OD_PERSIST_COMM.x2026_temperature[0],
        .attribute0 = ODA_SDO_R,
    ...
    .o_2027_motorStateRegister = {
        .dataOrig = &OD_PERSIST_COMM.x2027_motorStateRegister,
        .attribute = ODA_SDO_R | ODA_TPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2028_hallInputState = {
        .dataOrig = &OD_PERSIST_COMM.x2028_hallInputState,
        .attribute = ODA_SDO_R | ODA_TPDO | ODA_MB,
        .dataLength = 2
    },
    .o_6040_controlWord = {
    ...
    .o_6041_stateWord = {
        .dataOrig = &OD_PERSIST_COMM.x6041_stateWord,
        .attribute = ODA_SDO_R | ODA_TPDO | ODA_MB,
        .dataLength = 2
    },
    .o_6060_motionMode = {
        .dataOrig = &OD_PERSIST_COMM.x6060_motionMode,
        .attribute = ODA_SDO_RW | ODA_TRPDO,
        .dataLength = 1
    },
    .o_6061_motionModeState = {
        .dataOrig = &OD_PERSIST_COMM.x6061_motionModeState,
        .attribute = ODA_SDO_R | ODA_TPDO | ODA_MB,
        .dataLength = 4
    },
    .o_606C_currentSpeedFeedBack = {
        .dataOrig = &OD_PERSIST_COMM.x606C_currentSpeedFeedBack,
        .attribute = ODA_SDO_R | ODA_TRPDO | ODA_MB,
        .dataLength = 4
    },
    .o_6071_targetTorque = {
    ...
    .o_6074_realTimeCommandTorque = {
        .dataOrig = &OD_PERSIST_COMM.x6074_realTimeCommandTorque,
        .attribute = ODA_SDO_R | ODA_TPDO | ODA_MB,
        .dataLength = 2
    },
    .o_6077_realTimeTorqueFeedback = {
        .dataOrig = &OD_PERSIST_COMM.x6077_realTimeTorqueFeedback,
        .attribute = ODA_SDO_R | ODA_TPDO | ODA_MB,
        .dataLength = 2
    },
    ...
    .o_6081_maxSpeedPositionMode = {
        .dataOrig = &OD_PERSIST_COMM.x6081_maxSpeedPositionMode,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 4
    },
    .o_6082_starStopSpeedPositionMode = {
        .dataOrig = &OD_PERSIST_COMM.x6082_starStopSpeedPositionMode,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 4
    },
    .o_6083_STypeAccelerationTime = {
        .dataOrig0 = &OD_PERSIST_COMM.x6083_STypeAccelerationTime_sub0,
        .dataOrig = &OD_PERSIST_COMM.x6083_STypeAccelerationTime[0],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataElementLength = 4,
        .dataElementSizeof = sizeof(uint32_t)
    ...
    .o_6084_STypeDecelerationTime = {
        .dataOrig0 = &OD_PERSIST_COMM.x6084_STypeDecelerationTime_sub0,
        .dataOrig = &OD_PERSIST_COMM.x6084_STypeDecelerationTime[0],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataElementLength = 4,
        .dataElementSizeof = sizeof(uint32_t)
    ...
    .o_6085_emergencyStopDecelerationTime = {
        .dataOrig = &OD_PERSIST_COMM.x6085_emergencyStopDecelerationTime,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 4
    },
    .o_6087_torqueSlope = {
        .dataOrig = &OD_PERSIST_COMM.x6087_torqueSlope,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 4
    },
    .o_60FF_targetSpeed = {
        .dataOrig = &OD_PERSIST_COMM.x60FF_targetSpeed,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 4
    },
    .o_7040_controlWord = {
        .dataOrig = &OD_PERSIST_COMM.x7040_controlWord,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 2
    },
    .o_706C_currentSpeedFeedBack = {
        .dataOrig = &OD_PERSIST_COMM.x706C_currentSpeedFeedBack,
        .attribute = ODA_SDO_R | ODA_TRPDO | ODA_MB,
        .dataLength = 4
    },
    .o_70FF_targetSpeed = {
        .dataOrig = &OD_PERSIST_COMM.x70FF_targetSpeed,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 4
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x1281, 0x04, ODT_REC, &ODObjs.o_1281_SDOClientParameter, NULL},
    ...
    {0x2005, 0x01, ODT_VAR, &ODObjs.o_2005_clearFeedbackBit, NULL},
    {0x2006, 0x01, ODT_VAR, &ODObjs.o_2006_clearCurrentPositionBit, NULL},
    {0x2007, 0x01, ODT_VAR, &ODObjs.o_2007_limitedStopMethod, NULL},
    {0x2008, 0x01, ODT_VAR, &ODObjs.o_2008_turnOnSpeed, NULL},
    {0x2009, 0x01, ODT_VAR, &ODObjs.o_2009_registerConfiguration, NULL},
    {0x200A, 0x01, ODT_VAR, &ODObjs.o_200A_maxSpeed, NULL},
    {0x200D, 0x01, ODT_VAR, &ODObjs.o_200D_CANID, NULL},
    {0x200F, 0x01, ODT_VAR, &ODObjs.o_200F_syncFlag, NULL},
    {0x2013, 0x03, ODT_ARR, &ODObjs.o_2013_temperatureThreshold, NULL},
    {0x2014, 0x01, ODT_VAR, &ODObjs.o_2014_ratedCurrent, NULL},
    {0x2015, 0x01, ODT_VAR, &ODObjs.o_2015_maxCurrent, NULL},
    {0x2026, 0x03, ODT_ARR, &ODObjs.o_2026_temperature, NULL},
    {0x2027, 0x01, ODT_VAR, &ODObjs.o_2027_motorStateRegister, NULL},
    {0x2028, 0x01, ODT_VAR, &ODObjs.o_2028_hallInputState, NULL},
    {0x6040, 0x01, ODT_VAR, &ODObjs.o_6040_controlWord, NULL},
    {0x6041, 0x01, ODT_VAR, &ODObjs.o_6041_stateWord, NULL},
    {0x6060, 0x01, ODT_VAR, &ODObjs.o_6060_motionMode, NULL},
    {0x6061, 0x01, ODT_VAR, &ODObjs.o_6061_motionModeState, NULL},
    {0x606C, 0x01, ODT_VAR, &ODObjs.o_606C_currentSpeedFeedBack, NULL},
    {0x6071, 0x01, ODT_VAR, &ODObjs.o_6071_targetTorque, NULL},
    {0x6074, 0x01, ODT_VAR, &ODObjs.o_6074_realTimeCommandTorque, NULL},
    {0x6077, 0x01, ODT_VAR, &ODObjs.o_6077_realTimeTorqueFeedback, NULL},
    {0x607A, 0x01, ODT_VAR, &ODObjs.o_607A_targetPosition, NULL},
    {0x6081, 0x01, ODT_VAR, &ODObjs.o_6081_maxSpeedPositionMode, NULL},
    {0x6082, 0x01, ODT_VAR, &ODObjs.o_6082_starStopSpeedPositionMode, NULL},
    {0x6083, 0x03, ODT_ARR, &ODObjs.o_6083_STypeAccelerationTime, NULL},
    {0x6084, 0x03, ODT_ARR, &ODObjs.o_6084_STypeDecelerationTime, NULL},
    {0x6085, 0x01, ODT_VAR, &ODObjs.o_6085_emergencyStopDecelerationTime, NULL},
    {0x6087, 0x01, ODT_VAR, &ODObjs.o_6087_torqueSlope, NULL},
    {0x60FF, 0x01, ODT_VAR, &ODObjs.o_60FF_targetSpeed, NULL},
    {0x7040, 0x01, ODT_VAR, &ODObjs.o_7040_controlWord, NULL},
    {0x706C, 0x01, ODT_VAR, &ODObjs.o_706C_currentSpeedFeedBack, NULL},
    {0x70FF, 0x01, ODT_VAR, &ODObjs.o_70FF_targetSpeed, NULL},
